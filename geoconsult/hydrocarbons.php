<!DOCTYPE html>
    <head>
        ...
        <title>Hydrocarbon Solutions - Stellarsolve Energy</title>
...
<section id="sbs-1636">
    <div class="cs-container">
        <div class="cs-content">
            <div class="cs-flex">
                <span class="cs-topper">Low Carbon Hydrocarbon Solutions</span>
    ...
    <div class="cs-container">
        <div class="cs-top">
            ...
            <ul class="cs-ul">
                ...
                <li class="cs-li">
                    <a href="./hydrocarbons.php" class="cs-link active">Hydrocarbons</a>
                </li>
                <li class="cs-li">
