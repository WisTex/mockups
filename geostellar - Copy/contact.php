<html>
    <head>
        <title>Contact - Stellarsolve Energy</title>
            ...
            <div class="cs-top-bar">
                <div class="cs-top-container">
                    ...
                    <a href="./" class="cs-logo" aria-label="back to home">
                        <img src="./custom/image/stellarsolve-long.png" alt="logo" !width="197" !height="43" aria-hidden="true" decoding="async">
                    </a>
...
-->
            <ul class="cs-ul">
                ...
                <li class="cs-li">
                    <a href="./solutions.php" class="cs-link">
                        Solutions
                    </a>
                </li>
                <li class="cs-li">
                    <a href="./products.php" class="cs-link">
                        Products
                    </a>
                </li>
                <li class="cs-li">
                    <a href="./services.php" class="cs-link">
                        Services
                    </a>
                </li>
                <li class="cs-li">
                    <a href="./about.php" class="cs-link">
                        About
                    </a>
                </li>
                <li class="cs-li">
                    <a href="./contact.php" class="cs-link">
                        Contact Us
                    </a>
                </li>
            </ul>
