...
<div class="card-footer">
    ...
    <fieldset class="form-fieldset">  
      <div class="mb-3">
        ...
        <textarea class="form-control" name="example-textarea" placeholder="Please type or speak your command." rows="6">Highlight the SOM for signature for pay in the 3D viewer.</textarea>
      </div>
      <a href="v2.php" class="btn btn-info btn-sm mb-1">Compute</a>
