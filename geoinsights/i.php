...
<div class="card-footer">
  <a href="l.php" class="btn btn-primary btn-sm">Extract Channels</a>
                  </div>

    </div>              


    <div class="alert alert-danger rt alert-important alert-dismissible" role="alert">
                      <div class="d-flex">
                        <div>
