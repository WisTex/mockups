...
<html lang="en">
  <head>
    ...
    <title>Gulf of Mexico Data Set - Dashboard - Geophsyical Insights</title>
    ...
    <meta name="description" content="Geophsyical Insights"/>
          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <div class="card">
              <div class="card-body p-4 text-center">
                <span class="avatar avatar-xl mb-3 rounded" style="background-image: url(./images/gulf-study-area.png)"></span>
                <h3 class="m-0 mb-1"><a href="#">Gulf of Mexico</a></h3>
            ...
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/channel/username" >
              ...
              <li class="nav-item">
                <a class="nav-link" href="/photos/username" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
              ...
              <li class="nav-item">
                <a class="nav-link" href="/cloud/username" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(./static/wistex/scott.png)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div>Scott M. Stolz</div>
            ...
            <div>
              <form action="./" method="get" autocomplete="off" novalidate>
                <div class="input-icon">
                  ...
                  <input type="text" value="" class="form-control" placeholder="AI Command…" aria-label="Search in website">
                </div>
              </form>
            </div>
