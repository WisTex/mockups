                ...
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <small class="text-secondary">Paradise 4.0</small>
                        <h3 class="lh-1">Applications</h3>
                      </div>
                    </div>
...
<!--
    ...
    -->
                  <div class="card-footer">
                    <a href="map.php" class="btn btn-primary btn-sm">Change Location</a>
                    <a href="c.php" class="btn btn-primary btn-sm">Change Data Set</a>
                    <a href="m.php" class="btn btn-primary btn-sm">App Builder</a>              
                    <p class="mt-3"><small>Note: Apps will run using current location and data set, unless otherwise specified.</small></p>
                  </div>
                </div>
              ...
              <div class="col-lg-3">
                ...
                <div class="card-status-top bg-yellow"></div>
                  ...
                  <div class="card-body">
                    ...
                    </span>Neural Network Reservoir Characterization </h2> 
                    <p>Shell</p>
