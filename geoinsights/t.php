          ...
          <div class="container-xl">
            <div class="row row-cards">
              ...
              <div class="card mb-3" style="min-height: 500px;">
                  ...
                  <a href="u.php" class="btn btn-success btn-sm">Copy Stratigraphic Facies</a>
...
<div class="card-footer">
  ...
  <a href="w.php" class="btn btn-success btn-sm mb-1">Go Back to Selected Data</a>
    ...
    <fieldset class="form-fieldset">  
      ...
      <a href="w.php" class="btn btn-primary btn-sm mb-1">Compute</a>
      <a href="w.php" class="btn !btn-light btn-sm mb-1">&nbsp;
